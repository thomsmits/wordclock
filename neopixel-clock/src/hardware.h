 ...
 */
  ...
  const uint8_t DREIVIERTEL[] = { 81, 82, 83, 84, 85, 86, 87, 88, 89 ,90, 91, 0xff };
  const uint8_t VIERTEL[]     = { 85, 86, 87, 88, 89, 90, 91, 0xff };
  const uint8_t VOR[]         = { 80, 79, 78, 0xff };
  const uint8_t NACH[]        = { 73, 72, 71, 70, 0xff };
  const uint8_t HALB[]        = { 59, 60, 61, 62, 0xff };
  const uint8_t ELF[]         = { 64, 65, 66, 0xff };
  const uint8_t EIN[]         = { 58, 57, 56, 0xff };
  const uint8_t EINS[]        = { 58, 57, 56, 55, 0xff };
  const uint8_t ZWEI[]        = { 51, 50, 49, 48, 0xff };
  const uint8_t DREI[]        = { 37, 38, 39, 40, 0xff };
  const uint8_t FUENF[]       = { 66, 67, 68, 69, 0xff };
  const uint8_t VIER[]        = { 44, 45, 46, 47, 0xff };
  const uint8_t SECHS[]       = { 36, 35, 34, 33, 32, 0xff };
  const uint8_t ACHT[]        = { 29, 28, 27, 26, 0xff };
  const uint8_t SIEBEN[]      = { 15, 16, 17, 18, 19, 20, 0xff };
  const uint8_t ZWOELF[]      = { 21, 22, 23, 24, 25, 0xff };
  const uint8_t ZEHN[]        = { 14, 13, 12, 11, 0xff };
  const uint8_t UHR[]         = { 4, 5, 6, 0xff };
  const uint8_t NEUN[]        = { 11, 10, 9, 8, 0xff };
  const uint8_t PM[]          = { 115, 0xff };
  const uint8_t WECKER[]      = { 114, 0xff };
  const uint8_t MIN_1[]       = { 0, 0xff };
  const uint8_t MIN_2[]       = { 1, 0xff };
